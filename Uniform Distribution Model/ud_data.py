...
* This version is for outputting the data we need.
...
def new_predator_k():
    ...
    uniform distribution between 0 and kmax.

    Returns:
        A new k value. k ∈ (0,kmax).
    """
    new_k = np.random.uniform(0, 0.3)
    return new_k
...
with open('ud_data1.csv', 'a') as file_object_1:
...
with open('ud_data2.csv', 'a') as file_object_2:
