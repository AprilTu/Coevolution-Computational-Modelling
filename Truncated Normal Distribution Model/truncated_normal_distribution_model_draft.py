...
T = 200.0  # # float; maximum elapsed time
...
while t <= T:
    ...
    prey_birth_with_mutation = [ux * i.gi * i.Nx for i in current_prey_type]
    ...
    predation_with_birth_without_mutation = [i.Nx * l.Ny * l.kl * predation_rate(i.gi, l.kl) * (1-uy) for i in current_prey_type for l in current_predator_type] ## ☆ needed to be transformed into nd_array
    predation_with_birth_with_mutation = [i.Nx * l.Ny * l.kl * predation_rate(i.gi, l.kl) *uy for i in current_prey_type for l in current_predator_type]  ## ☆ needed to be transformed into nd_array
