...
with open('tnd_data1.csv', 'a') as file_object_1:
...
while cycle_number_count < cycle_number:
    ...
    while t <= T:
        ...
        prey_num_array = np.array(current_prey_nx)
        total_prey_num = prey_num_array.sum()

        prey_birth_nonmutant = bx * (1-ux) * prey_g_array * prey_num_array
        ...
        predator_num_array = np.array(current_predator_ny)
...
with open('tnd_data2.csv', 'a') as file_object_2:
